...
#------------------------------------------------------------------------------- 
# Read the data 
myData = read.csv("output-station.csv")
#------------------------------------------------------------------------------- 
...
fileNameRoot = "air-result-Station-DailyTol-" 
graphFileType = "pdf" 
#-------------------------------------------r------------------------------------ 
...
mcmcCoda = genMCMC( data=myData , 
                    ...
                    zName="DailyTol", NName="Dummy", sName="DateStation", cName="Station",
...
summaryInfo = smryMCMC( mcmcCoda , compVal=NULL , 
                        ...
                        diffCVec=c(1,2,3,4,5,6,7,8,9) , # Four Season
...
plotMCMC( mcmcCoda , data=myData , 
          ...
          zName="DailyTol", NName="Dummy", sName="DateStation", cName="Station", 
          compVal=NULL ,
          diffCList=list( c("Tamshui","Erlin") ,
                          c("Erlin","Tainan") ,# Compare Spring and Summer
                          c("Tamshui","Tainan") ,
                          c("Taoyuan","Shalu") ,
                          c("Shalu","Fengshan") ,
                          c("Taoyuan","Fengshan") ,
                          c("Sanchong","Changhua") ,
                          c("Changhua","Pingtung") ,
                          c("Sanchong","Pingtung") ) , # Compare Autumn and Winter
